...
- [ ] **🔴 Пилотная живая серия RIZALTA inbound** — 19.04: 5-6 тестеров × 5-6 звонков = ~30 inbound calls на +79310091644. MixMonitor запишет все. После серии: Сергей прослушивает WAV + cross-ref с journalctl, определяет rate of drop-offs / Sofia-initiated refusals / audio dropouts. Решение о Option A prompt hardening принимается based on tester-call attrition pattern.
