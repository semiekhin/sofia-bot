...
STAGES = [
    ...
    "ACTUALIZATION",  # Актуализация холодного лида
...
STAGE_PATTERNS = {
    ...
    "ACTUALIZATION": [
        ...
        r"не оставлял",
        r"какой сайт",
        r"откуда.{0,15}(номер|контакт|телефон)",
        r"кто (это|вы|такие)",
        r"не (интересно|актуально|нужно)",
        r"(да|нет).{0,5}(интересно|актуально)",
        r"актуально",
        r"неактуально",
        r"откуда (вы|у вас)",
        r"где (оставлял|заявк)",
    ],
