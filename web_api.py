...
Пример расчёта (студия ~17 млн ₽, горизонт 5 лет):
- Недвижимость: стоимость вырастет до ~33 млн + аренда ~8 млн = итого ~41 млн (+139%)
- Депозит: с учётом снижения ставок и налога 13% = итого ~24 млн (+40%)
- Разница: +17 млн ₽ в пользу недвижимости

Ключевые аргументы:
- Депозит теряет доходность каждый год (ставки падают), недвижимость — наоборот, растёт
- На стройке рост ~20%/год, готовый объект ~10%/год + аренда ~10%/год
...
- При бюджете 20+ млн можно взять 1-спальню: выше доход от аренды
