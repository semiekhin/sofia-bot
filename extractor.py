...
ОБОБЩАЮЩИЕ ОТВЕТЫ ПРО ОПЛАТУ:
Если бот спросил про способ оплаты, а клиент ответил неопределённо — это payment_type: "any", confidence: "confirmed".
Примеры:
- "не знаю", "не определился", "пока не решил"
- "любой", "без разницы", "всё равно", "как удобнее"
- "смотря что предложите", "зависит от условий"
- "можно любой", "рассмотрю все варианты"

Это НЕ отказ отвечать, это ПОДТВЕРЖДЁННЫЙ выбор "any".
