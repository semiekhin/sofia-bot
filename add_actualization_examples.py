...
RAG_FILE = os.path.join(SOFIA_PATH, "rag_training_data.json")
EXAMPLE_FILES = [
    os.path.join(SOFIA_PATH, "actualization_rag_examples.json"),
    os.path.join(SOFIA_PATH, "actualization_rag_examples_extra.json"),
]
...
def main():
    ...
    for filepath in EXAMPLE_FILES:
        try:
            ...
            print(
                f"📥 {filepath}: +{len(unique_new)} диалогов"
