...
## Интеграция с Битрикс24 (планируется)
```
Битрикс24 (исходящий вебхук ONCRMLEADADD)
         ↓ POST с телефоном и именем
   http://72.56.64.91:5001/api/bitrix/lead (НЕ создан ещё)
         ↓
   sofia_outreach.sh whatsapp 79... Имя
         ↓
   WABA шаблон → клиент
```
