...
SEND_PATTERNS = [
    "скинь", "отправь", "пришли", "покажи", "дай вариант",
    "скиньте", "отправьте", "пришлите", "покажите",
    "можно варианты", "есть варианты", "что есть", "что у вас есть",
    "хочу посмотреть", "хочу увидеть"
]

CALL_REJECT_PATTERNS = [
    "не хочу звон", "не надо звон", "не могу звон",
    "без звонк", "не созван", "лучше скинь", "просто скинь",
    "не хочу созван", "занят", "некогда", "нет времени",
    "давайте без звонка", "без созвона", "скинь лучше"
]

NEUTRAL_PATTERNS = [
    "без разницы", "всё равно", "все равно", "любой", "любая", "любое",
    "не важно", "неважно", "как хотите", "на ваш выбор", "пофиг",
    "не знаю", "незнаю", "хз", "как угодно", "мне всё равно"
]

IRRITATED_PATTERNS = [
    "издеваешься", "издеваетесь", "достал", "достали", "хватит",
    "много вопросов", "сколько можно", "надоел", "надоели",
    "я же сказал", "я же говорил", "повторяю", "в третий раз",
    "ещё раз говорю", "уже говорил", "сколько раз", "опять",
    "достаточно", "хорош", "стоп", "прекрати", "прекратите",
    "отстань", "отстаньте", "до свидания", "досвидания", "пока",
    "мозги", "трахать", "сука", "блять", "бля", "нахуй", "пиздец"
]

CALL_AGREE_PATTERNS = [
    "да, давайте", "давайте созвон", "давайте звон", "можно созвон",
    "окей, созвон", "хорошо, созвон", "согласен на созвон",
    "удобно сегодня", "удобно завтра", "давайте завтра", "давайте сегодня",
    "можно завтра", "можно сегодня", "во сколько"
]
